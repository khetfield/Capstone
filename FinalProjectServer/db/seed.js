...
async function createInitialProducts() {
  try {
    ...
    await client.query(`
      ...
      (4.99, 'Fruit', 'Blueberries', 'Produce', 'https://media.healthyfood.com/wp-content/uploads/2017/03/Why_we_like_blueberries.jpg', 't', ''),
      ...
      (3.19, 'Bakery', 'White Bread', 'Bakery', 'https://img.freepik.com/premium-photo/slice-bread-white-background-isolated-with-clipping-path_41722-1877.jpg', 't', ''),
